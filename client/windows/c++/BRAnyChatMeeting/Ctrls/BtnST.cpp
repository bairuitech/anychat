...
#pragma warning(disable: 4244 4312 4311)
...
/**
 *	当在OCX控件里面应用CButtonST时，由于PreTransMessage方法无效，不能激活ToolTip，采用该可以模拟
 */
void CButtonST::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
...
DWORD CButtonST::SetURL(LPCTSTR lpszURL)
{
	...
	{
		// Store the URL
		strncpy(m_szURL,lpszURL, _MAX_PATH);
	} // if

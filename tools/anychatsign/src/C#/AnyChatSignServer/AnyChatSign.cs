...
namespace AnyChatSignServer
{
    public class AnyChatSign
    {
        ...
        public static extern int AnyChatRsaSign(int userId, StringBuilder appId, StringBuilder privateKey, StringBuilder outSignStr, int signStrSize, ref int timeStamp);
        ...
        public static extern int AnyChatRsaVerify(int userId, StringBuilder appId, StringBuilder signStr, int timeStamp, StringBuilder publicKey);
    }
}

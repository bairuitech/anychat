...
public class FuncMenuAty extends Activity implements AnyChatBaseEvent,OnClickListener,AnyChatObjectEvent {
	...
	private void InitLayout() {
		...
		waitingpd = new ProgressDialog(FuncMenuAty.this);
		this.setTitle("营业厅列表");
	...
	private void AnyChatEnterAreaResult(int dwObjectType, int dwObjectId,
		...
		//dwParam1 进入营业厅返回结果，0表示进入营业厅成功
			...
			in.setClass(FuncMenuAty.this, YeWuActivity.class);
			startActivity(in);
			waitingpd.dismiss();
			//座席角色
			...
			Intent in=new Intent();
			in.setClass(FuncMenuAty.this,AgentServerAty.class);
			startActivity(in);
			waitingpd.dismiss();
		}

...
public class FuncMenuActivity extends Activity implements AnyChatBaseEvent,OnClickListener,AnyChatObjectEvent {
	...
	// 功能菜单图标
	private int[] arrFuncIcons = { R.drawable.icon_one, R.drawable.icon_two,
			R.drawable.icon_one, R.drawable.icon_two};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.titlebar_new);
        SetData();
		//视频参数配置
		ApplyVideoConfig();	
		//初始化sdk

...
public class LoginActivity extends Activity implements AnyChatBaseEvent, AnyChatObjectEvent {
    ...
    private ImageView user_icon1; //客户
    private ImageView user_icon2; //坐席
    private EditText mEditIP; // ip
    private EditText mEditPort; // 端口
    private EditText mEditName; // 用户名
    private ImageView luYouStatus; //是否路由的开关
    private boolean autoMode = true; //是否路由标记
    ...
    private void InitAgentLayout() {
        ...
        //路由模式
        luYouStatus = (ImageView) this.findViewById(R.id.imageView_auto);
        luYouStatus.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if(autoMode){
                    autoMode = false;
                    luYouStatus.setImageResource(R.drawable.luyou_off);
                }else{
                    autoMode = true;
                    luYouStatus.setImageResource(R.drawable.luyou_on);
                }
            }
        });
        // 2.初始化容器
    ...
    private void InitLayout() {
        ...
        user_icon1 = (ImageView)findViewById(R.id.image_user_icon1);
        user_icon2 = (ImageView)findViewById(R.id.image_user_icon2);
        user_icon1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                user_icon1.setImageResource(R.drawable.customer_on);
                user_icon2.setImageResource(R.drawable.agen_off);
                mUserTypeCode = 0;
                viewAgentContainer.setVisibility(View.GONE);
            }
        });
        user_icon2.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                user_icon2.setImageResource(R.drawable.agen_on);
                user_icon1.setImageResource(R.drawable.customer_off);
                mUserTypeCode = 2;
    ...
    public void OnAnyChatLoginMessage(int dwUserId, int dwErrorCode) {
        ...
        if (dwErrorCode == 0) {
            ...
            if(autoMode){
                intent.putExtra("autoMode", 0);// 1关闭，0开启
            }else{
                intent.putExtra("autoMode", 1);// 1关闭，0开启
            }
